...
public class LuncheMessageRecieveListenerImpl implements LuncheMessageRecieveListener {
    ...
    @Inject
    public LuncheMessageRecieveListenerImpl(final SuperlunchRequestHandler superlunchRequestHandler, final TextHandler textHandler, final BotConfiguration botConfiguration, final MessageRecieverBase messageRecieverBase, final LunchMessageProtocol lunchMessageProtocol, final HipchatRequestHandler hipchatRequestHandler) {
