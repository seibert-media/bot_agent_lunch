...
public final class ConnectionImpl implements Connection, MessageListener, ConnectionListener {
  ...
  @Inject
  public ConnectionImpl(final ChatConnectionConfiguration chatConnectionConfiguration, final EventSystem eventSystem, final Bot bot)
      throws IOException {
    this.chatConnectionConfiguration = chatConnectionConfiguration;
    this.eventSystem = eventSystem;
    this.bot = bot;
    this.xmpp = new XMPPConnection(
        new ConnectionConfiguration(chatConnectionConfiguration.getXmppUrl(), chatConnectionConfiguration.getXmppPort()));
  }
